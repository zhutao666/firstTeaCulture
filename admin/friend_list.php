...
//记录的总条数
$total_num=mysql_num_rows(mysql_query("select id from friend"));
//每页记录数
$pagesize=5;
//总页数
...
$result=mysql_query("select * from friend order by id desc limit $offset,$pagesize");
?>
...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
	...
	?>
    <tr>
      <td height="43" colspan="3" align="center"> <?=$page?>/<?=$page_num?>&nbsp;&nbsp;<a href="?page=1">首页</a>&nbsp;&nbsp;	<a href="?page=<?=$prepage?>">上一页</a>&nbsp;&nbsp;<a href="?page=<?=$nextpage?>">下一页</a>&nbsp;&nbsp;<a href="?page=<?=$page_num?>"> 尾页</a></td>
    </tr>
  </table>
</body>
</html>
